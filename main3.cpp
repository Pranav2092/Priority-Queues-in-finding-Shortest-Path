...
int main() {
    ...
    vector<pair<int, int>> path1 = astar1(h, graph, start, end);
    ...
    vector<pair<int, int>> path2 = astar2(h, graph, start, end);
    ...
    vector<pair<int, int>> path3 = astar3(h, graph, start, end);
